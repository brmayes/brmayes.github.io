			...
			<?php if ( isset( $mixfolio_options[ 'mixfolio_display_contact_information' ] ) || isset( $mixfolio_options[ 'mixfolio_twitter_id' ] ) ) : ?>
				<div class="columns four">
					<?php if ( isset( $mixfolio_options[ 'mixfolio_twitter_id' ] ) ) : ?>
						...
						<a class="twitter-timeline" href="https://twitter.com/twitterapi" data-widget-id="487225123984785408" data-tweet-limit="1" data-chrome="noheader nofooter noborders noscrollbar transparent" data-screen-name="<?php echo $mixfolio_options[ 'mixfolio_twitter_id' ]; ?>"></a>
						<hr />
					<?php endif; ?>
